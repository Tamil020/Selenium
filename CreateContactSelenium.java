...
public class CreateContactSelenium {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//input[@id='firstNameField']")).sendKeys("TAMILVANANKUMAR");
		driver.findElement(By.xpath("//input[@id='lastNameField']")).sendKeys("K");
		driver.findElement(By.id("createContactForm_firstNameLocal")).sendKeys("Tamilvanan");
		...
		driver.findElement(By.xpath("//input[contains(@id,'_primaryEmail')]")).sendKeys("tamilvanankumar13@gamil.com");
