...
public class EditLeadSelenium {
	...
	public static void main(String[] args)throws InterruptedException {
		...
		driver.findElement(By.xpath("(//div[@id='center-content-column']//input)[2]")).sendKeys("Tamilvanan");
		driver.findElement(By.xpath("//button[text()='Find Leads']")).click();
		driver.findElement(By.xpath("//a[text()='Tamilvanan']")).click();
		Thread.sleep(5000);
		...
		String text = driver.findElement(By.xpath("(//span[@class='tabletext'])[5]")).getText();
